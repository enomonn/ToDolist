...
<div class="flex bg-white p-10">
    <a class ="mr-5 text-red-600" href={{"/goal/".$goal->id}}>{{$goal->third_goals_name}}</a>
...
<div id="page1" class="page active">
    <h1 class ="mr-5" href={{"/goal/".$goal->id}}>{{$goal->first_goals_name}}</h1>
        <h2>1日目</h2>
    ...
    <div id="page2" class="page">
        <h1 class ="mr-5" href={{"/goal/".$goal->id}}>{{$goal->second_goals_name}}</h1>
        <h2>8日目</h2>
    ...
    <div id="page3" class="page">
        <h1 class ="mr-5" href={{"/goal/".$goal->id}}>{{$goal->third_goals_name}}</h1>
        <h2>15日目</h2>
    ...
    <button onclick="showPage(1)">一週目</button>
    <button onclick="showPage(2)">二週目</button>
    <button onclick="showPage(3)">三週目</button>
    <script>
